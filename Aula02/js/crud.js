const usuarios = [
  { id: 1, nome: "Ana Banana", email: "banana@teste.com" },
  { id: 2, nome: "Pafúncio Souza", email: "souza@teste.com" },
];

function renderizarUsuarios() {
  const usuariosDiv = document.getElementById("usuarios");
  usuariosDiv.innerHTML = ""; //serve para limpar a div q será inserida por appenchild
